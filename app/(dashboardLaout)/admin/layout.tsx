  ...
  if (loading) {
    return (
      <div className="h-screen flex items-center justify-center bg-gray-50">
        <LoadingSpinner size={48} text="Admin dashboard loading..." />
      </div>
    );
  }
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col">
      ...
      <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-gray-900 text-white">
        ...
        <span className="font-bold">SkillBridge 🛡️</span>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          <nav className="space-y-2">
            ...
            {navItem("/admin/bookings", "Bookings", BookOpen)}
            {navItem("/admin/categories", "Categories", Layers)}
          </nav>

          {/* Footer */}
          <div className="absolute bottom-4 text-xs text-gray-400">
            Admin Panel • SkillBridge
          </div>
        </aside>
